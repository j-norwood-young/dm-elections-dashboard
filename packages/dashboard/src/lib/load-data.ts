import { seats2009, seats2014, seats2019, seats2024 } from "./urls.js";
...
export const generateHemicycleInformation = (
  year: string,
  data: ElectionResults
) => {
  const calculateSeats = (arr: ElectionResults) =>
    arr.reduce((partialSum, item: ResultItem) => partialSum + item.Seats, 0);
