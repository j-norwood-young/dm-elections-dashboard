<script>
    ...
    $: xPosition =
        tooltipData.x + tooltipWidth + xNudge > width
            ? tooltipData.x - tooltipWidth - xNudge
            : tooltipData.x + xNudge;
    $: yPosition =
        tooltipData.y + tooltipHeight + yNudge > height
    ...
    <div class="electionengine-tooltip-container">
        ...
        <div class="electionengine-tooltip-section">
            <div class="electionengine-tooltip-thead">
                Percentage of Seats Won in Limpopo
            </div>
            <div
                ...
                <div class="electionengine-tooltip-range">
                    <div class="electionengine-tooltip-outer">
                        <div
                            ...
                            style="width:{tooltipData.party
                                .vote_perc}%; background:{tooltipData.color}"
                        ></div>
                    </div>
                </div>
        ...
        <div class="electionengine-tooltip-section">
            <div class="electionengine-tooltip-thead">
                Total Number of Seats Won in Limpopo
            </div>
            <div class="electionengine-tooltip-tdata">
